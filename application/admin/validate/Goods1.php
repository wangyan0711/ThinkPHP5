...
class Goods extends Validate
{
    ...
    protected $message = [
        ...
        'english_name.require' => '商品名称不能为空！',
        'thumb_hidden.require'   => '商品缩略图不能为空！',
    ...
    protected $scene = [
        //添加商品
        'add'  => ['category_id', 'name', 'english_name', 'thumb_hidden', 'content', 'pic', 'market_price', 'sell_price', 'sell_num', 'stock', 'sku'],

        //修改商品
        'edit' => ['id', 'category_id', 'name', 'english_name', 'thumb_hidden', 'content', 'pic', 'market_price', 'sell_price', 'sell_num', 'stock', 'sku'],
